...
// Dependencies
var readline = require('readline') // used to read in text from the console
var util = require('util')
var debug = util.debuglog('cli')
var events = require('events') // used to list to events from the cli
class _events extends events {}
var e = new _events()
var os = require('os') // used to get cpu information
var v8 = require('v8') // used to get runtime information
