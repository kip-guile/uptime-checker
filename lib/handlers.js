...
var dns = require('dns') // used to resolve host names, prior to adding them as checks
var _url = require('url')
var _performance = require('perf_hooks').performance // measure code execution times
