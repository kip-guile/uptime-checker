...
let dns = require('dns') // used to resolve host names, prior to adding them as checks
let _url = require('url')
let _performance = require('perf_hooks').performance // measure code execution times
